...
const FlightCard = (props) => {
  ...
  return (
    <TouchableOpacity activeOpacity={0.5}>
        ...
        <View style={{ flexDirection: "row" }}>
          <View style={styles.cardBottomDetails}>
            ...
            <View style={{ flexDirection: "row", alignItems: "center" }}>
              ...
              <Text style={{ alignSelf: "center", fontSize: 13 }}>9</Text>
            </View>
            {/* Suitcase Icon */}
            <View
              style={{
          ...
          <View style={{ flexDirection: "column" }}>
            ...
            <View style={{ flexDirection: "row", paddingTop: 6 }}>
              ...
              <Text style={{ fontWeight: "900", color: "#00aeef" }}>
                {props.points}
              </Text>
      ...
      {/* Similar Results */}
      <View style={styles.similarResults}>
        <TouchableOpacity activeOpacity={0}
          style={styles.seeMoreButton}
          onPress={() => {
            console.log("See More Results button pressed");
          }}
        >
          <Text style={styles.seeMoreButtonText}>See More Results (4)</Text>
        </TouchableOpacity>
      </View>
    </TouchableOpacity>
  );
